...
// Do executes specified HTTP method with provided requestBody (if not nil) and
...
// Post executes a POST request with provided requestBody and then calls the
...
func (c *client) Post(
	...
	return c.Do(ctx, onResponse, "POST", url, requestBody, opts...)
}
